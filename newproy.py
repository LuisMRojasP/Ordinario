...
for i in moto_paths:
    ...
    numcanales = wav_file.getnchannels()          # Número de canales
    tammuestra = wav_file.getsampwidth()      # Dígitos de cuantización
    tasafra = wav_file.getframerate()        # Frecuencia de muestreo
    numfra = wav_file.getnframes()           # Número de puntos de muestreo
    '''print("Audio: ",i)
